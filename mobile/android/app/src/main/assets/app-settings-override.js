(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '.ms-native-settings-action{justify-self:end;min-height:32px;padding:7px 11px;border:0;border-radius:8px;background:var(--theme-primary-color);color:#fff;font:inherit;font-size:.76rem;font-weight:900;white-space:nowrap}',
