(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      '.ms-native-settings-back{display:inline-flex;align-items:center;gap:6px;justify-self:start;min-height:30px;padding:0;border:0;background:transparent;color:var(--theme-primary-color);font:inherit;font-size:.95rem;font-weight:850}',
      '.ms-native-settings-header h2{max-width:12ch;margin:0;color:#1d354f;font-size:1.5rem;font-weight:600;letter-spacing:0;line-height:1.12}',
      ...
      '.ms-native-settings-group-title{display:flex;align-items:center;gap:8px;padding:14px 18px 4px;color:#6d7f91;font-size:.75rem;font-weight:600;line-height:1;text-transform:uppercase}',
      ...
      '.ms-native-settings-row-icon{display:grid;width:34px;height:34px;place-items:center;border-radius:8px;background:rgb(var(--theme-primary) / .08);color:var(--theme-primary-color)}',
      ...
      '.ms-native-settings-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#1d354f;font-size:.98rem;font-weight:600;line-height:1.2}',
      ...
      '.ms-native-settings-row.is-button em{color:var(--theme-primary-color);font-size:1.35rem;font-weight:500}',
      '.ms-native-settings-pill{justify-self:end;padding:7px 9px;border-radius:999px;background:#f1f5f9;color:#5d7287;font-size:.72rem;font-weight:600;line-height:1;white-space:nowrap}',
      ...
      '.ms-native-settings-action{justify-self:end;min-height:32px;padding:7px 11px;border:0;border-radius:8px;background:var(--theme-primary-color);color:#fff;font:inherit;font-size:.76rem;font-weight:600;white-space:nowrap}',
      ...
      '.ms-native-settings-switch input:checked+i{background:var(--theme-primary-color)}',
