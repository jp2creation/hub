...
class CrmFrontendSourceTest extends TestCase
{
    public function test_crm_shell_is_loaded_from_versioned_vite_source(): void
    {
        ...
        $openingAnimation = base_path('mobile/src/assets/opening-animation.mp4');
        $androidIntroAnimation = base_path('mobile/android/app/src/main/res/raw/intro.mp4');
        $openingAnimationHash = '57eabab00730cad2fd1dd72d71f6bad857b5018a2761669e48f5a85353473908';
        ...
        $this->assertFileDoesNotExist(base_path('mobile/src/assets/opening-animation.gif'));
        ...
        $this->assertStringContainsString("const openingAnimationUrl = new URL('./assets/opening-animation.mp4', import.meta.url).href", $mobileApp);
        ...
        $this->assertStringContainsString("introVideo.addEventListener('ended', complete, { once: true })", $mobileApp);
        $this->assertStringContainsString("introVideo.addEventListener('error', complete, { once: true })", $mobileApp);
