...
class CrmFrontendSourceTest extends TestCase
{
    public function test_crm_shell_is_loaded_from_versioned_vite_source(): void
    {
        ...
        $openingAnimationHash = '93f9c9d3673ec2db7e4701e578edd84899aa74ca1b8710de4878e3311c655c49';
        ...
        $this->assertStringContainsString('private static final long SPLASH_DURATION_MS = 12600L;', $mainActivity);
        ...
        $this->assertStringContainsString('const openingAnimationDurationMs = 12600', $mobileApp);
