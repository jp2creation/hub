import hubLogoUrl from "./logo-hub.svg";
...
(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      #${rootId} .admin-title h1{display:flex;align-items:center;gap:.48rem;flex-wrap:wrap;margin:0;color:var(--admin-text);font-size:1.8rem;line-height:1.1;font-weight:600;letter-spacing:0}
      #${rootId} .admin-title-logo{display:block;width:auto;height:1.62rem;max-width:min(4.9rem,42vw);object-fit:contain}
  ...
  function renderContent() {
    return `
      <section class="admin-shell">
        <div class="admin-top">
          <div class="admin-title">
            <h1><span>Administration</span><img class="admin-title-logo" src="${hubLogoUrl}" alt="HUB" loading="lazy"></h1>
